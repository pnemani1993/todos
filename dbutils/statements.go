...
const TRIAL = `INSERT INTO tasks (task, description, done, high_priority, alert) VALUES
('Task 1', 'Description for task 1', 0, 0, NULL),
('Task 2', 'Description for task 2', 1, 1, '2025-06-14 10:00:00'),
('Task 3', 'Description for task 3', 0, 1, '2025-06-15 09:00:00'),
('Task 4', 'Description for task 4', 1, 0, NULL),
('Task 5', 'Description for task 5', 0, 0, '2025-06-16 14:30:00'),
('Task 6', 'Description for task 6', 0, 1, NULL),
('Task 7', 'Description for task 7', 1, 1, '2025-06-17 12:00:00'),
('Task 8', 'Description for task 8', 0, 0, NULL),
('Task 9', 'Description for task 9', 1, 0, '2025-06-18 08:00:00'),
('Task 10', 'Description for task 10', 0, 1, NULL);`
